  ...
  return (
    <div className="bg-gray-darker min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-text mb-8">
          About Gray Bear
        </h1>

        <div className="space-y-8">
          <section>
            <h2 className="text-xl font-bold text-amber-brand mb-3">Our Mission</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-brand mb-3">What We Believe</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={value.title} className="bg-gray-dark rounded-lg p-5 border border-gray-light">
                  <h3 className="text-gray-text font-semibold mb-2">{value.title}</h3>
                  <p className="text-gray-muted text-sm leading-relaxed">{value.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-amber-brand mb-3">Our Team</h2>
          ...
          <div className="bg-gray-dark rounded-xl p-8 border border-gray-light text-center">
            <h2 className="text-xl font-bold text-gray-text mb-3">Ready to Find Your Next Adventure?</h2>
            <p className="text-gray-muted mb-6">
              Browse our directory of verified guides, outfitters, and charters.
            </p>
            <Link
              href="/search"
              className="inline-block bg-amber-brand text-gray-dark px-6 py-3 rounded-lg font-semibold hover:bg-amber-light transition-colors"
            >
              Browse Listings
            </Link>
          </div>
